...
const (
	// ----- content types ----
	codecSelferCcUTF87848 = 1
	codecSelferCcRAW7848  = 255
	// ----- value types used ----
	codecSelferValueTypeArray7848  = 10
	codecSelferValueTypeMap7848    = 9
	codecSelferValueTypeString7848 = 6
	codecSelferValueTypeInt7848    = 2
	codecSelferValueTypeUint7848   = 3
	codecSelferValueTypeFloat7848  = 4
	codecSelferBitsize7848         = uint8(32 << (^uint(0) >> 63))
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct7848 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer7848 struct{}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeStringEnc(codecSelferCcUTF87848, `msg_type`)
				r.WriteMapElemValue()
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.Source))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
			} else {
				if yyq2[1] {
					r.WriteMapElemKey()
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `source`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.Destination))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[2] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `dest`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.TransactionUUID))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[3] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF87848, `transaction_uuid`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.TransactionUUID))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.ContentType))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[4] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF87848, `content_type`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.ContentType))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.Accept))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[5] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `accept`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `status`)
					}
					r.WriteMapElemValue()
					if yyn21 {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `rdr`)
					}
					r.WriteMapElemValue()
					if yyn26 {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `headers`)
					}
					r.WriteMapElemValue()
					if x.Headers == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[9] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `metadata`)
					}
					r.WriteMapElemValue()
					if x.Metadata == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[10] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `spans`)
					}
					r.WriteMapElemValue()
					if x.Spans == nil {
						r.EncodeNil()
		...
		LABEL40:
			if yyr2 || yy2arr2 {
				...
				if yyq2[11] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF87848, `include_spans`)
					r.WriteMapElemValue()
					if yyn40 {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[12] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.Path))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[12] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `path`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[13] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `payload`)
					}
					r.WriteMapElemValue()
					if x.Payload == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[14] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.ServiceName))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[14] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF87848, `service_name`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.ServiceName))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[15] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.URL))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[15] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `url`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[16] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF87848, `partner_ids`)
					r.WriteMapElemValue()
					if x.PartnerIDs == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[17] {
					if false {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.TraceParent))
					}
				} else {
					r.EncodeStringEnc(codecSelferCcUTF87848, "")
				}
				...
				if yyq2[17] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF87848, `trace_parent`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeStringEnc(codecSelferCcUTF87848, string(x.TraceParent))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[18] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF87848, `traces`)
					}
					r.WriteMapElemValue()
					if x.Traces == nil {
						r.EncodeNil()
...
func (x *Message) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap7848 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				r.ReadMapEnd()
			} else {
		...
		} else if yyct2 == codecSelferValueTypeArray7848 {
			...
			panic(errCodecSelferOnlyMapOrArrayEncodeToStruct7848)
		}
	}
}
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "trace_parent":
			if r.TryDecodeAsNil() {
				...
				x.TraceParent = (string)(r.DecodeString())
			}
		case "traces":
			if r.TryDecodeAsNil() {
				x.Traces = nil
...
func (x *Message) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
		} else if yyxt35 := z.Extension(z.I2Rtid(x.Type)); yyxt35 != nil {
...
func (x codecSelfer7848) encSliceSlicestring(v [][]string, e *codec1978.Encoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer7848) decSliceSlicestring(v *[][]string, d *codec1978.Decoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer7848) encSlicestring(v []string, e *codec1978.Encoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.WriteArrayStart(len(v))
	for _, yyv1 := range v {
		...
		if false {
			...
			r.EncodeStringEnc(codecSelferCcUTF87848, string(yyv1))
		}
	}
	r.WriteArrayEnd()
}

func (x codecSelfer7848) decSlicestring(v *[]string, d *codec1978.Decoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer7848) encSliceMapstringstring(v []map[string]string, e *codec1978.Encoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.WriteArrayStart(len(v))
...
func (x codecSelfer7848) decSliceMapstringstring(v *[]map[string]string, d *codec1978.Decoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer7848) encMapstringstring(v map[string]string, e *codec1978.Encoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	...
	for yyk1, yyv1 := range v {
		...
		if false {
			...
			r.EncodeStringEnc(codecSelferCcUTF87848, string(yyk1))
		}
		r.WriteMapElemValue()
		if false {
		} else {
...
func (x codecSelfer7848) decMapstringstring(v *map[string]string, d *codec1978.Decoder) {
	var h codecSelfer7848
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
