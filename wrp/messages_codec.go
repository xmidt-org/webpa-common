...
const (
	// ----- content types ----
	codecSelferCcUTF8413 = 1
	codecSelferCcRAW413  = 0
	// ----- value types used ----
	codecSelferValueTypeArray413  = 10
	codecSelferValueTypeMap413    = 9
	codecSelferValueTypeString413 = 6
	codecSelferValueTypeInt413    = 2
	codecSelferValueTypeUint413   = 3
	codecSelferValueTypeFloat413  = 4
	codecSelferBitsize413         = uint8(32 << (^uint(0) >> 63))
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct413 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer413 struct{}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF8413, `msg_type`)
				r.WriteMapElemValue()
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.Source))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
			} else {
				if yyq2[1] {
					r.WriteMapElemKey()
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `source`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.Destination))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
				...
				if yyq2[2] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `dest`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.TransactionUUID))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
				...
				if yyq2[3] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF8413, `transaction_uuid`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeString(codecSelferCcUTF8413, string(x.TransactionUUID))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.ContentType))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
				...
				if yyq2[4] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF8413, `content_type`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeString(codecSelferCcUTF8413, string(x.ContentType))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.Accept))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
				...
				if yyq2[5] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `accept`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `status`)
					}
					r.WriteMapElemValue()
					if yyn21 {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `rdr`)
					}
					r.WriteMapElemValue()
					if yyn26 {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `headers`)
					}
					r.WriteMapElemValue()
					if x.Headers == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[9] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `metadata`)
					}
					r.WriteMapElemValue()
					if x.Metadata == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[10] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `spans`)
					}
					r.WriteMapElemValue()
					if x.Spans == nil {
						r.EncodeNil()
		...
		LABEL40:
			if yyr2 || yy2arr2 {
				...
				if yyq2[11] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF8413, `include_spans`)
					r.WriteMapElemValue()
					if yyn40 {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[12] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.Path))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
				...
				if yyq2[12] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `path`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[13] {
					if x.Payload == nil {
						...
						if false {
							...
							r.EncodeStringBytes(codecSelferCcRAW413, []byte(x.Payload))
						}
					}
				} else {
					r.EncodeNil()
				...
				if yyq2[13] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `payload`)
					}
					r.WriteMapElemValue()
					if x.Payload == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[14] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.ServiceName))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
				...
				if yyq2[14] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF8413, `service_name`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeString(codecSelferCcUTF8413, string(x.ServiceName))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[15] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF8413, string(x.URL))
					}
				} else {
					r.EncodeString(codecSelferCcUTF8413, "")
				}
				...
				if yyq2[15] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeString(codecSelferCcUTF8413, `url`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[16] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF8413, `partner_ids`)
					r.WriteMapElemValue()
					if x.PartnerIDs == nil {
						r.EncodeNil()
					} else {
...
func (x *Message) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap413 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				r.ReadMapEnd()
			} else {
		...
		} else if yyct2 == codecSelferValueTypeArray413 {
			...
			panic(errCodecSelferOnlyMapOrArrayEncodeToStruct413)
		}
	}
}
...
func (x codecSelfer413) encSliceSlicestring(v [][]string, e *codec1978.Encoder) {
	var h codecSelfer413
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer413) decSliceSlicestring(v *[][]string, d *codec1978.Decoder) {
	var h codecSelfer413
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer413) encSlicestring(v []string, e *codec1978.Encoder) {
	var h codecSelfer413
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.WriteArrayStart(len(v))
	for _, yyv1 := range v {
		...
		if false {
			...
			r.EncodeString(codecSelferCcUTF8413, string(yyv1))
		}
	}
	r.WriteArrayEnd()
}

func (x codecSelfer413) decSlicestring(v *[]string, d *codec1978.Decoder) {
	var h codecSelfer413
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
