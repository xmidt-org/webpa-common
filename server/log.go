...
func NewErrorLog(logger logging.Logger, serverName string) *log.Logger {
...
func NewConnectionStateLogger(logger logging.Logger, serverName string) func(net.Conn, http.ConnState) {
