...
type expectation func(t testingT, name string, metric any) bool
...
func Value(expected float64) expectation {
	return func(t testingT, n string, m any) bool {
...
func Counter(t testingT, n string, m any) bool {
...
func Gauge(t testingT, n string, m any) bool {
...
func Histogram(t testingT, n string, m any) bool {
